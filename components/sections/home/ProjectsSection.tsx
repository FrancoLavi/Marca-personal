...
export function ProjectsSection({ locale = "es" }: { locale?: "en" | "es" }) {
  const copy = locale === "en"
    ? { eyebrow: "Projects", title: "Selected projects", description: "Digital solutions built to make what matters simpler.", link: "View all projects" }
    : { eyebrow: "Proyectos", title: "Algunos proyectos", description: "Soluciones digitales construidas para hacer más simple lo importante.", link: "Ver todos los proyectos" };
